...
# from ./inventree-audit-log-plugin import audit_log_api_urls
from inventree_audit_log.api import audit_log_api_urls
...
apipatterns = [
    ...
    # path('api/audit/',include()),
    path('aa/', include(audit_log_api_urls)),
    path(
        'generate/',
        include([
            path(
