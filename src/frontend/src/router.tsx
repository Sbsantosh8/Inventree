...
export const EnquiryIndex = Loadable(
  lazy(() => import('./components/enquiry/EnquiryDetail'))
);

export const NewEnquiry = Loadable(
  lazy(() => import('./components/enquiry/NewEnquiry'))
);

export const EnquiryDetail = Loadable(
  lazy(() => import('./components/enquiry/EnquiryDetail'))
);
...
export const routes = (
  <Routes>
    ...
    {/* <Route path='enquiry/'>
        <Route index element={<Navigate to='index/' />} />
        <Route path='index/*' element={<EnquiryIndex />} />
        <Route path='new/*' element={<NewEnquiry />} />
        <Route path=':id/*' element={<EnquiryDetail />} />
      </Route>
    </Route>  */}
